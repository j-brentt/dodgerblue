...
# This group of test cases were generated by Copilot Chat Agent in VSCode
class InboxFederationTests(TestCase):
    """
    Verify node-to-node inbox handling: likes and comments posted by a remote node
    create a local stub Author and attach the like/comment to the target object.
    """
    ...
    def setUp(self):
        ...
        # entry owned by the recipient (target of remote like/comment)
        ...
        # Remote node configuration (credentials used by RemoteNodeBasicAuthentication)
        self.remote_node = RemoteNode.objects.create(
            name="Remote Node",
            base_url="https://remote.example.com/api",
            username="remoteuser",
    ...
    def test_inbox_accepts_like_from_remote_node(self):
        ...
        payload = {
            ...
            "object": f"http://testserver/api/entries/{self.entry.id}/",
        }
        ...
        try:
            ...
            self.fail("Remote author was not created")

        # entry should have the remote author in its liked_by set
